...
Les Skills sont composés de fichiers Markdown simples et de scripts shell associés. Le script de bootstrap ([https://kstack.sh/install](https://kstack.sh/install)) détecte chaque agent pris en charge dans votre `PATH` et les installe : Claude Code, OpenAI Codex CLI, OpenCode, Cursor, Factory Droid, Slate, Kiro, Hermes. Le comportement est identique entre les agents ; seul le chemin d'installation diffère.
